...
« employé transféré de Terre-Neuve ayant droit à pension » Personne qui était, selon le cas :
  ...
  * _b_) un employé du Newfoundland Fisheries Board;
...
« participant »
  ...
  * _b.1_) personne astreinte à contribuer au compte de régimes compensatoires par les articles 8 ou 9 du [Règlement no 1 sur le régime compensatoire](/canada/fra/reglements/DORS/DORS-94-785.md);
...
« traitement »
  ...
  * _c_) dans le cas d’un participant qui est astreint à contribuer au compte de régimes compensatoires par les articles 8 ou 9 du [Règlement no 1 sur le régime compensatoire](/canada/fra/reglements/DORS/DORS-94-785.md), le traitement visé aux paragraphes 8(3) ou 9(1) de ce règlement.
