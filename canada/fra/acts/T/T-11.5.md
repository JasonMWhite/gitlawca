...
(4) Dans les cas où les critères visés aux alinéas (1)_a_) ou _b_) ne s’appliquent pas à la commandite et sous réserve des règlements, il est possible d’utiliser un élément de marque d’un produit du tabac dans la promotion de la commandite.
...
(2) Il est interdit de faire la promotion d’accessoires sur lesquels figure un élément de marque d’un produit du tabac sauf selon les modalités réglementaires et dans les publications ou les endroits mentionnés aux alinéas 22(2)_a_) à _c_).
