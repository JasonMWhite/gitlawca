...
(4) Le gouverneur en conseil peut prendre des règlements concernant :
  ...
  * _b_) la réduction de pension de l’officier lorsqu’un choix a été effectué;

  * _c_) le montant de la pension accordée en vertu du paragraphe (2);
