...
**1.1** (1) Le gouverneur en conseil peut constituer la Commission des nominations publiques, formée d’au plus cinq membres, dont le président, pour exercer les fonctions suivantes :
  ...
  * _d_) procéder à la vérification des politiques et des méthodes de nomination afin de contrôler l’observation du code de pratique;

  * _e_) faire rapport publiquement sur l’observation du code de pratique par le gouvernement et l’administration, notamment présenter un rapport annuel au premier ministre pour communication au président de chaque chambre du Parlement pour dépôt et renvoi pour étude devant le comité compétent;

  * _f_) sensibiliser le public à la question et former les fonctionnaires chargés de mener les processus de nomination et de renouvellement de mandat relevant du code de pratique;

  * _g_) exécuter toutes autres fonctions qu’il peut préciser.
