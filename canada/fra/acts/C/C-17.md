...
(2) Le comité est ainsi composé :
  ...
  * _b_) trois membres choisis parmi les personnes tenues de contribuer à la Caisse de retraite des Forces canadiennes, lesquels sont proposés par le chef d’état-major de la défense pour représenter les militaires;
...
**50.** (1) Le gouverneur en conseil peut, par règlement :
  ...
  * _g_) fixer un taux de solde annuel pour l’application du paragraphe 5(5) ou prévoir son mode de détermination;
