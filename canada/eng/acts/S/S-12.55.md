...
(1.1) Despite subsection (1), if the rate of charge provided for by section 12.1 applies in respect of an export of a softwood lumber product from a region during a month and the conditions referred to in paragraphs (1)(_a_) and (_b_) are met, the amount of the charge applicable in respect of the export is the amount determined by the formula
