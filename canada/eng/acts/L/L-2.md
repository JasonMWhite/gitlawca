...
**209.4** The Governor in Council may make regulations
  ...
  * (_a_) specifying the absences from employment that shall be deemed not to have interrupted continuous employment referred to in sections 206 and 206.1;
  ...
  * (_b_) specifying what does, or does not, constitute an essential function of a job referred to in section 208; and
...
**239.** (1) Subject to subsection (1.1), no employer shall dismiss, suspend, lay off, demote or discipline an employee because of absence due to illness or injury if
  ...
  * (_b_) the period of absence does not exceed twelve weeks; and
