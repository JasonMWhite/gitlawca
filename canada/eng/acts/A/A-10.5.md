...
**12.** (1) Subject to subsection (3), if an air transportation service is acquired in Canada, the amount of the charge in respect of the service is
  ...
  * (_a_) $11.22 for each chargeable emplanement included in the service, to a maximum of $22.43, if
  ...
  * (_b_) $12.00 for each chargeable emplanement included in the service, to a maximum of $24.00, if
