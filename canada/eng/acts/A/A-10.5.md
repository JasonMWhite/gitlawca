...
**12.** (1) Subject to subsection (3), if an air transportation service is acquired in Canada, the amount of the charge in respect of the service is
  ...
  * (_a_) $4.67 for each chargeable emplanement included in the service, to a maximum of $9.33, if
  ...
  * (_b_) $4.90 for each chargeable emplanement included in the service, to a maximum of $9.80, if
  ...
  * (_d_) $8.34 for each chargeable emplanement included in the service, to a maximum of $16.68, if
...
(2) Subject to subsection (3), if an air transportation service is acquired outside Canada, the amount of the charge in respect of the service is
  ...
  * (_b_) $8.34 for each chargeable emplanement by an individual on an aircraft used to transport the individual to a destination outside Canada but within the continental zone, to a maximum of $16.68, if
