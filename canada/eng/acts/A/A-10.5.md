...
**12.** (1) Subject to subsection (3), if an air transportation service is acquired in Canada, the amount of the charge in respect of the service is
  ...
  * (_a_) $5.61 for each chargeable emplanement included in the service, to a maximum of $11.22, if
  ...
  * (_b_) $6.00 for each chargeable emplanement included in the service, to a maximum of $12.00, if
  ...
  * (_c_) $9.35 for each chargeable emplanement included in the service, to a maximum of $18.69, if
  ...
  * (_d_) $10.00 for each chargeable emplanement included in the service, to a maximum of $20.00, if
  ...
  * (_e_) $20.00, if the service includes transportation to a destination outside the continental zone.
...
(2) Subject to subsection (3), if an air transportation service is acquired outside Canada, the amount of the charge in respect of the service is
  ...
  * (_a_) $9.35 for each chargeable emplanement by an individual on an aircraft used to transport the individual to a destination outside Canada but within the continental zone, to a maximum of $18.69, if

    * (i) the service does not include transportation to a destination outside the continental zone, and

    * (ii) tax under subsection 165(1) of the [Excise Tax Act](/canada/eng/acts/E/E-15.md) is required to be paid in respect of the service;

  * (_b_) $10.00 for each chargeable emplanement by an individual on an aircraft used to transport the individual to a destination outside Canada but within the continental zone, to a maximum of $20.00, if

    * (i) the service does not include transportation to a destination outside the continental zone, and

    * (ii) tax under subsection 165(1) of the [Excise Tax Act](/canada/eng/acts/E/E-15.md) is not required to be paid in respect of the service; or

  * (_c_) $20.00, if the service includes transportation to a destination outside the continental zone.
