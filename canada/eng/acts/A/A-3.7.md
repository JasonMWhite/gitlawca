...
**21.** (1) For the purposes of this Part, a producer is in default under a repayment agreement if the producer
  ...
  * (_c_) has not met all of their obligations under the agreement when the producer files an assignment under the [Bankruptcy and Insolvency Act](/canada/eng/acts/B/B-3.md) or a receiving order is made under that Act against the producer;
