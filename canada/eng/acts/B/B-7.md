...
### Section 5. _Voting_
    ...
    * (_a_) Each member shall have two hundred and fifty votes plus one additional vote for each part of its quota equivalent to one hundred thousand special drawing rights.
