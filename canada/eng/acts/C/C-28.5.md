...
(4) A special allowance ceases to be payable with the payment for the month in which the child in respect of whom the special allowance is payable
  ...
  * (_d_) reaches eighteen years of age.
...
**8.** (1) The amount of special allowance to be paid in respect of a child for each month is one twelfth of the total of
  ...
  * (_a_) the amount expressed in dollars in paragraph (_a_) of the description of A in subsection 122.61(1) of the [Income Tax Act](/canada/eng/acts/I/I-3.3.md), and

  * (_b_) the amount expressed in dollars in paragraph (_a_) of the description of F in that subsection,
