...
**7.** Each member of the Board is entitled to be paid
  ...
  * (_a_) an amount fixed by the Treasury Board for each day or part of a day that the member is performing duties under this Act unless the member is employed in the public service of Canada; and
...
**12.1** (1) The jurisdiction of the Tribunal in relation to the following matters shall be exercised by the Chairperson of the Tribunal:
  ...
  * (_c_) requests under paragraph 9(3)(_c_) or subsection 13(2) of that Act for a review in respect of a notice of violation that sets out a penalty of less than $2,000.
